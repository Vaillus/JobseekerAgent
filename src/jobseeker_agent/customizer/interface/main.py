...
from jobseeker_agent.customizer.interface.routes import bp
...
def create_app():
    ...
    app.register_blueprint(bp, url_prefix="/customizer")
    return app
...
if __name__ == "__main__":
    ...
    # For example: http://127.0.0.1:5001/customizer/apply/71
    print("Customizer dashboard running. Please navigate to /customizer/apply/<job_id>")
    print("Example: http://127.0.0.1:5001/customizer/apply/71")
